...
// Function prototypes
float cMarks(int caMarks);
float fMarks(int finalMarks);
...
int main() {
    ...
    assert(fabs(cMarks(100) + fMarks(100) - 100) < 0.01);
    ...
    totalMarks = cMarks(caMarks) + fMarks(finalMarks);
...
// Function to calculate final exam marks contribution
float fMarks(int finalMarks) {
    return finalMarks * 0.6;
}
